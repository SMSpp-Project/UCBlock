/*--------------------------------------------------------------------------*/
/*----------------------- File AcadThermalUnitMIPBlock.h -------------------*/
/*--------------------------------------------------------------------------*/
/** @file
...
#ifndef AcadThermalUnitMIPBlock_H_
#define AcadThermalUnitMIPBlock_H_
...
class AcadThermalUnitMIPBlock : public Block {
 ...
 *  @{ */
	AcadThermalUnitMIPBlock(UCBlock * fblock = nullptr);
/**< Constructor of AcadThermalUnitBlock, taking possibly a pointer of its father 
  *  Block, alongside with setting the Unit without rampconstraints */
	...
	virtual ~AcadThermalUnitMIPBlock();
///< destructor of BusNetWorkBlock: it is virtual, and empty

/*@} -----------------------------------------------------------------------*/
/*------ METHODS FOR READING THE DATA OF THE AcadThermalUnitMIPBlock -------*/
/*--------------------------------------------------------------------------*/
/** @name Reading the data of the AcadThermalUnitMIPBlock
    @{ */
...
/*@} -----------------------------------------------------------------------*/
/*------- METHODS FOR HANDLING THE DATA OF THE AcadThermalUnitMIPBlock -----*/
/*--------------------------------------------------------------------------*/
/** @name Handling the data of the AcadThermalUnitMIPBlock
    @{ */
...
/*@} -----------------------------------------------------------------------*/
/*---- METHODS CONSTRUCTING THE CONSTRAINTS OF AcadThermalUnitMIPBlock -----*/
/*--------------------------------------------------------------------------*/
/** @name Methods constructing the constraints of AcadThermalUnitMIPBlock
 *  @{ */
...
/*@} -----------------------------------------------------------------------*/
/*---- METHODS COMPUTING THE START UP COSTS OF AcadThermalUnitMIPBlock -----*/
/*--------------------------------------------------------------------------*/
/** @name Methods computing the start-up costs of AcadThermalUnitMIPBlock
 *  @{ */
...
/*--------------------------------------------------------------------------*/
/** @name Constraints and Objective Function of AcadThermalUnitMIPBlock
 *  @{ */
 ...
 *  @{ */
     ...
     std::vector<ColVariable> P_hk;    //prepei na ginei boost::multi_array<ColVariable,2>
