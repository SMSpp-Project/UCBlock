 ...
 * @{ */
  ...
  * feasible considering a given tolerance. The tolerance can be
  ...
  *
  * Each Constraint of this BatteryUnitBlock is a RowConstraint and a
  * solution is considered feasible if and only if
  *
  *   -# the relative violation of each RowConstraint of this
  *      BatteryUnitBlock is not greater than the tolerance; and
  *
  *   -# the bounds on each ColVariable are satisfied considering the given
  *      tolerance. Since every ColVariable of this BatteryUnitBlock is
